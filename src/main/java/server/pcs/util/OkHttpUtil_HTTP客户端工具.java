 ...
 *
 */
public class OkHttpUtil_HTTP客户端工具 {
	...
	private static class OkHttpHolder {
		private static OkHttpUtil_HTTP客户端工具 instance = new OkHttpUtil_HTTP客户端工具();
		private static OkHttpUtil_HTTP客户端工具 simpleInstance = new OkHttpUtil_HTTP客户端工具(true);
	}

	/**
	 * OkHttpClient
	 */
	public OkHttpUtil_HTTP客户端工具() {
		ConnectionPool connectionPool = new ConnectionPool(100, 30, TimeUnit.MINUTES);
		/**
		 * 定义 OkHttpClient
		 * 把 httpUrl、cookies 整合到一起=OkHttpClient。
		 */
	...
	public OkHttpUtil_HTTP客户端工具(boolean b) {
	...
	public static OkHttpUtil_HTTP客户端工具 getInstance() {
		//SystemUtil.logDebug("okhttp被调用了。");
		return OkHttpHolder.instance;
	}

	public static OkHttpUtil_HTTP客户端工具 getSimpleInstance() {
